#!/usr/bin/env bun
/**
 * Kvasir Comment via cast wallet sign (EIP-191)
 *
 * End-to-end flow:
 ...
 *
 * Usage:
 *   bun kvasir-comment.ts --kvasir "The Resonance Kvasir" --post "abc123" --content "Great post!"
 *   bun kvasir-comment.ts --kvasir "SHRIMP" --post "abc123" --content "Hello"
 *
...
async function main() {
  ...
  if (!postId) {
    ...
    console.error('Usage: bun kvasir-comment.ts --kvasir "Name" --post "id" --content "text"')
    process.exit(1)
  }
