...
2. Git history
3. GitHub issues
4. The ancestors you just learned (opensource-nat-brain-kvasir, kvasir-v2)
...
The retrospective is written to the vault (wherever `Kvasir/` resolves).
